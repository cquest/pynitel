...
class Pynitel:
    ...
    def wait(self):
      ...
      while self.conn.read(1) != b' ' : # ESC reçu... on considère qu'on est connecté
        time.sleep(1)
    ...
    def waitzones(self,zone):
        ...
        while True:
            ...
            (self.zones[zone-1]['texte'],touche) = self.input(self.zones[zone-1]['ligne'],
    ...
    def zone(self,ligne, colonne, longueur, texte, couleur):
        ...
        self.zones.append({"ligne": ligne, "colonne": colonne,"longueur":longueur,"texte":texte,"couleur":couleur})
